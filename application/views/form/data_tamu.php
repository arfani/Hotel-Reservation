...
<div class="form-group">
  ...
  <input type="tel" pattern="^\d{10,12}$" class="form-control" id="phone" placeholder="e.g: 081907456710"/>
</div>
<div class="form-group">
  <label for="email">Email :</label>
  <input type="email" class="form-control" id="email" placeholder="e.g: arfanihidayat@gmail.com"/>
</div>
<div class="form-group">
  <label for="address">Address :</label>
  <textarea rows="4" class="form-control" id="address" placeholder="e.g: Jl. Beo2 No.22 Karang Kemong, Cakranegara barat, Mataram."></textarea>
</div>
</div>
</div>
